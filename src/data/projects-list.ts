export const projectsList = [
  ...
  },
  {
    ...
    desc: `Social app built with React Native and Firebase.`,
...

  {
    ...
    desc: `Fully functional clothing ecommerce website with firebase auth(Google,Email/Pass) and stripe payments integration.`,
...

  {
    ...
    desc: `This is an instant messaging webapp built from scratch with JWT authentication.`,
  ...
  },
  {
    ...
    desc: `A full stack digital marketplace running on Ethereum with Polygon & Next.js`,
    technologies: ['nextjs', 'ethereum', 'javascript']
  }
];
